...
const HOUSE_PHRASES: readonly string[] = [
  ...
  'Potje golfen met Marian',
  'Migrate:fresh draaien',
  'Een probleem niet melden',
  'Jordy aan het werk zetten',
  'Een andere agent vragen om mijn werk te doen',
  'Potje Clash Royale spelen',
  'Pokemon Go spelen',
  'Doen alsof er gewerkt wordt',
  ...
  'Zich voorbereiden voor de bootcamp',
  ...
  'Project verwijderen',
  'een nieuwe projectstructuur voorstellen',
];
